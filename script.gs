...
"evento"
, 
"ubicacion_del_evento"
, 
"ubicación_del_evento"
, 
"ubicacion"
, 
"ubicación"
...
"get_swimmer_marks_with_context"
:
     
case
 
"get_marks_with_context"
:
...
json_
( 
handleGetSwimmerMarksWithContext_
(
params
) );
...
error
: 
"coach_id y swimmer_id requeridos"
 };
...
error
:
"allow_marks_edit/allow_marks_delete requeridos"
 };
...
error
:
"Nadador no encontrado o no pertenece al coach"
 };
